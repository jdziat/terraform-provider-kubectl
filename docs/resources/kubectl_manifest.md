...
> use the [kubectl_path_documents](https://registry.terraform.io/providers/jdziat/kubectl/latest/docs/data-sources/kubectl_path_documents) data source to split the files into individual resources.
